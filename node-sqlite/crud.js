...
// SQL Statement
var CREATE_TABLE = "CREATE TABLE IF NOT EXISTS fdb ( id INTEGER PRIMARY KEY AUTOINCREMENT, judul TEXT NOT NULL,"+
    " release TEXT NOT NULL, imdb TEXT, deskripsi TEXT )";
...
selectAllData();
function dropTable(){
    db.run("Drop Table fdb", function(err){
        if (err){
            console.log(err);
        }
        else {
            console.log("Table is droped")
        }
    })
}
 dropTable();
